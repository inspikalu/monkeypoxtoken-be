...
export const WebEclipseEth = getBoundSolana({ name: "eclipse-eth", ticker: "ETH", providerUrl: "https://mainnetbeta-rpc.eclipse.xyz" });
...
export const WebUSDCSolana = getBoundSPL({ name: "usdc-solana", ticker: "USDC", providerUrl: "https://api.mainnet-beta.solana.com/", contractAddress: "EPjFWdd5AufqSSqeM2qN1xzybapC8G4wEGGkZwyTDt1v" });
