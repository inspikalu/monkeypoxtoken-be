...
import SolanaConfig from "./token.js";
...
export class SPLConfig extends SolanaConfig {
    ...
    async _createTxUnsigned(amount, to, fee) {
        ...
        transaction.add(createTransferInstruction(fromTokenAccount.address, toTokenAccount, keys.publicKey, +new BigNumber(amount).toNumber()));
